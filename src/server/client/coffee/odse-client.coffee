...
window.odse.TransactioNodeListManager = window.odse.TransactioNodeListManager
class OdseConfigs
...
window.odse.OdseConfigs = window.odse.OdseConfigs
...
window.odse.GenericUtilities = window.odse.GenericUtilities
...
window.odse.TransactioNode = window.odse.TransactioNode
...
window.odse.ServerOdseApiCall = window.odse.ServerOdseApiCall
...
window.odse.StorageDecider = window.odse.StorageDecider
###
...
###
  ...
  The most important this to note here is that whatever data passed by an 'emit' function of an window.odse.EventEmitter
...
###
  @class OdseEvent
  The base window.odse.Event for our system. It is both Sequencial and Async. I've mirrored the 'storedData' in the 'detail'
...
###
  ...
  This window.odse.Event has bubbling support.
...
###
  @note Nodes
  Nodes are like the building blocks of the system. Since they need to emit events, they need to have window.odse.EventEmitter in their
  prototype chain. That's why window.odse.OdseNode extends window.odse.EventEmitter.
  the following methods of window.odse.EventEmitter is fundamentally important -
...
###
  @class @abstract window.odse.OdseNode
...
class OdseNode extends window.odse.EventEmitter
  ...
  _attachTo: (parentNode)->
    throw new Error "Expected <window.odse.ContainerNode>" unless parentNode instanceof window.odse.ContainerNode
...
###
  @class @abstract window.odse.ValueNode
...
###
  @exports
###
window.odse.OdseEvent = window.odse.OdseEvent
window.odse.BubbleableOdseEvent = window.odse.BubbleableOdseEvent

window.odse.ObjectDataStorageEngine = window.odse.ObjectDataStorageEngine
window.odse.ArrayNode = window.odse.ArrayNode
window.odse.ObjectNode = window.odse.ObjectNode
window.odse.ContainerNode = window.odse.ContainerNode
window.odse.PrimitiveNode = window.odse.PrimitiveNode
window.odse.ValueNode = window.odse.ValueNode
window.odse.OdseNode = window.odse.OdseNode

window.odse.CustomError = window.odse.CustomError
window.odse.VendorError = window.odse.VendorError
window.odse.DeveloperError = window.odse.DeveloperError
window.odse.ExtendedError = window.odse.ExtendedError
...
window.odse.TransactioNodeManager = window.odse.TransactioNodeManager
...
window.odse.ConstructOdseTree = window.odse.ConstructOdseTree
...
window.odse.ClientStorageHandler = window.odse.ClientStorageHandler
...
window.odse.ClientPendingSyncHandler = new window.odse.ClientPendingSyncHandler()
