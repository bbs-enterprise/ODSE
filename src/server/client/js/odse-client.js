...
(function() {
  var ArrayNode, BasicTestRunner, BubbleableOdseEvent, ClientPendingSyncHandler, ClientStorageHandler, ClientXhrClient, ConstructOdseTree, ContainerNode, ErrorEvent, Event, EventEmitter, GenericUtilities, InitialDataDissection, Iterator, ObjectDataStorageEngine, ObjectNode, OdseConfigs, OdseEvent, OdseNode, PrimitiveNode, ServerOdseApiCall, StorageDecider, TransactioNode, TransactioNodeListManager, TransactioNodeManager, ValueNode, iterate,
  ...
  ServerOdseApiCall = (function() {
    ...
    ServerOdseApiCall.genericClientApiCall = function(partialUrl, data, cbfn) {
      var cxcObj, url;
      if ((typeof data) === 'object') {
        data = JSON.stringify(data);
      }
    ...
    ServerOdseApiCall.getWebRequestObject = function() {
      if (window.odse.GenericUtilities.isRunningOnServer() === true) {
