...
(function() {
  var ArrayNode, BubbleableOdseEvent, ClientPendingSyncHandler, ClientStorageHandler, ConstructOdseTree, ContainerNode, ErrorEvent, Event, EventEmitter, GenericUtilities, InitialDataDissection, Iterator, ObjectDataStorageEngine, ObjectNode, OdseConfigs, OdseEvent, OdseNode, PrimitiveNode, ServerOdseApiCall, StorageDecider, TransactioNode, TransactioNodeListManager, TransactioNodeManager, TreeMerger, ValueNode,
  ...
  OdseNode = (function(superClass) {
    ...
    OdseNode.prototype._attachTo = function(parentNode) {
      if (!(parentNode instanceof window.odse.ContainerNode)) {
        throw new Error("Expected <window.odse.ContainerNode>");
      }
