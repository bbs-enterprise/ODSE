...
(function() {
  var ArrayNode, BasicTestRunner, BubbleableOdseEvent, ClientOdseStorage, ClientPendingSyncHandler, ClientStorageHandler, ClientXhrClient, ConstructOdseTree, ContainerNode, ErrorEvent, Event, EventEmitter, GenericUtilities, InitialDataDissection, Iterator, ObjectDataStorageEngine, ObjectNode, OdseApiCall, OdseConfigs, OdseEvent, OdseNode, PrimitiveNode, StorageDecider, TransactioNode, TransactioNodeListManager, TransactioNodeManager, ValueNode, iterate, setImmediate,
  ...
  if (!setImmediate || setImmediate === null || (typeof setImmediate) === 'undefined') {
  ...
  OdseConfigs = (function() {
    ...
    OdseConfigs.webProtocol = 'http://';

    OdseConfigs.hostName = 'localhost';

    OdseConfigs.hostPort = '8671';

    OdseConfigs.serverRootUrl = OdseConfigs.webProtocol + OdseConfigs.hostName + ':' + OdseConfigs.hostPort + '/';
  ...
  ClientXhrClient = (function() {
    var _init, _onReadyStateChange, _onRequestError, localCbfnRefernence, xhrObj;

    xhrObj = null;

    localCbfnRefernence = null;

    function ClientXhrClient() {
      this.postRequest = bind(this.postRequest, this);
      _init();
    }

    _init = function() {
      return xhrObj = new XMLHttpRequest();
    };
    ...
    _onReadyStateChange = function() {
      ...
      if (xhrObj.readyState === 4 && xhrObj.status === 200) {
        ...
        return localCbfnRefernence(JSON.parse(result));
      }
    };
    ...
    ClientXhrClient.prototype.postRequest = function(url, data, cbfn) {
    ...
    return ClientXhrClient;

  })();

  window.odse.ClientXhrClient = ClientXhrClient;

  OdseApiCall = (function() {
    function OdseApiCall() {}

    OdseApiCall.genericServerApiCall = function(partialUrl, data, cbfn) {
    ...
    OdseApiCall.genericClientApiCall = function(partialUrl, data, cbfn) {
      var cxcObj, url;
      if ((typeof data) === 'object') {
        data = JSON.stringify(data);
      }
      ...
      return cxcObj.postRequest(url, data, cbfn);
    };

    OdseApiCall.getWebRequestObject = function() {
      if (window.odse.GenericUtilities.isRunningOnServer() === true) {
    ...
    OdseApiCall.clearAllOdseDataApi = function(cbfn) {
      var webRequestMethod;
      webRequestMethod = window.odse.OdseApiCall.getWebRequestObject();
      return webRequestMethod('clear-all-odse-data', {}, (function(_this) {
    ...
    OdseApiCall.callSaveNewTransactionHistoryApi = function(transactionList, cbfn) {
      var webRequestMethod;
      webRequestMethod = window.odse.OdseApiCall.getWebRequestObject();
      return webRequestMethod('save-new-transaction-history', transactionList, (function(_this) {
        return function(response) {
          if ((window.odse.GenericUtilities.isNotNull(cbfn)) === true) {
            return cbfn(response.data);
          }
    ...
    OdseApiCall.callGetTransactionHistoryApi = function(blobId, cbfn) {
      var webRequestMethod;
      webRequestMethod = window.odse.OdseApiCall.getWebRequestObject();
      return webRequestMethod('get-transaction-history', {
        blobId: blobId
      }, (function(_this) {
        return function(response) {
          if ((window.odse.GenericUtilities.isNotNull(cbfn)) === true) {
    ...
    OdseApiCall.callSaveNewNodeIdPathListApi = function(nodeIdPathList, cbfn) {
      var webRequestMethod;
      webRequestMethod = window.odse.OdseApiCall.getWebRequestObject();
      return webRequestMethod('save-new-node-id-path-list', nodeIdPathList, (function(_this) {
        return function(response) {
          if ((window.odse.GenericUtilities.isNotNull(cbfn)) === true) {
            return cbfn(response.data);
          }
    ...
    OdseApiCall.callGetNodeIdPathListApi = function(blobId, cbfn) {
      var webRequestMethod;
      webRequestMethod = window.odse.OdseApiCall.getWebRequestObject();
      return webRequestMethod('get-node-id-path-list', {
        blobId: blobId
      }, (function(_this) {
        return function(response) {
          if ((window.odse.GenericUtilities.isNotNull(cbfn)) === true) {
  ...
  ClientStorageHandler = (function() {
    var _getItem, _setItem, storageObj;
    ...
    function ClientStorageHandler() {
      ...
      this.forceSet = bind(this.forceSet, this);
      this.clearTheStorage = bind(this.clearTheStorage, this);
      var error, ex;
      try {
    ...
    ClientStorageHandler.prototype.clearTheStorage = function(key) {
      return storageObj.removeItem(key);
    };

    ClientStorageHandler.prototype.forceSet = function(key, value) {
  ...
  ClientOdseStorage = (function() {
    function ClientOdseStorage() {}

    ClientOdseStorage.getClientStorageObject = function() {
      var cshObj;
    ...
    ClientOdseStorage.clearTheClientOdseStorageData = function() {
      var cshObj;
      ...
      return cshObj.clearTheStorage(window.odse.OdseConfigs.clientStorageKeyNameForTransactions);
    };

    ClientOdseStorage.forceInitializeClientStorageAfterSync = function() {
      var cshObj;
      cshObj = window.odse.ClientOdseStorage.getClientStorageObject();
      cshObj.forceSet(window.odse.OdseConfigs.clientStorageKeyNameForIdPath, []);
      return cshObj.forceSet(window.odse.OdseConfigs.clientStorageKeyNameForTransactions, []);
    };

    ClientOdseStorage.initializeClientStorage = function(cshObj) {
      if ((window.odse.GenericUtilities.isNotNull(cshObj.get(window.odse.OdseConfigs.clientStorageKeyNameForIdPath))) === false) {
        cshObj.set(window.odse.OdseConfigs.clientStorageKeyNameForIdPath, []);
      }
      if ((window.odse.GenericUtilities.isNotNull(cshObj.get(window.odse.OdseConfigs.clientStorageKeyNameForTransactions))) === false) {
        return cshObj.set(window.odse.OdseConfigs.clientStorageKeyNameForTransactions, []);
      }
    };

    ClientOdseStorage.callSaveNewTransactionHistoryApi = function(transactionList, cbfn) {
      var cshObj;
      cshObj = window.odse.ClientOdseStorage.getClientStorageObject();
      cshObj.set(window.odse.OdseConfigs.clientStorageKeyNameForTransactions, transactionList);
      return cbfn('New transaction history has been saved successfully(CLIENT).');
    };

    ClientOdseStorage.callSaveNewNodeIdPathListApi = function(nodeIdPathList, cbfn) {
      var cshObj;
      cshObj = window.odse.ClientOdseStorage.getClientStorageObject();
      cshObj.set(window.odse.OdseConfigs.clientStorageKeyNameForIdPath, nodeIdPathList);
      return cbfn('New node ID path list has been saved successfully(CLIENT).');
    };

    ClientOdseStorage.callGetNodeIdPathListApi = function(blobId, cbfn) {
      var cshObj, item, j, len1, nodePathIdList, res;
      cshObj = window.odse.ClientOdseStorage.getClientStorageObject();
      nodePathIdList = cshObj.get(window.odse.OdseConfigs.clientStorageKeyNameForIdPath);
      res = [];
      for (j = 0, len1 = nodePathIdList.length; j < len1; j++) {
        item = nodePathIdList[j];
        if (item.blobId === blobId) {
          res = res.concat(item.allNodeIdPathList);
        }
      }
      return cbfn(blobId, res);
    };

    ClientOdseStorage.callGetTransactionHistoryApi = function(blobId, cbfn) {
      var cshObj, item, j, len1, res, transactionHistoryList;
      cshObj = window.odse.ClientOdseStorage.getClientStorageObject();
      transactionHistoryList = cshObj.get(window.odse.OdseConfigs.clientStorageKeyNameForTransactions);
      res = [];
      for (j = 0, len1 = transactionHistoryList.length; j < len1; j++) {
        item = transactionHistoryList[j];
        if (item.blobId === blobId) {
          res.push(item);
        }
      }
  ...
  StorageDecider = (function() {
    ...
    StorageDecider.clearServerStorage = function(cbfn) {
      return window.odse.OdseApiCall.clearAllOdseDataApi(cbfn);
    };

    StorageDecider.clearClientStorage = function(cbfn) {
      return window.odse.ClientOdseStorage.clearTheClientOdseStorageData();
    };

    StorageDecider.initializeClientStorage = function() {
      return window.odse.ClientOdseStorage.initializeClientStorage();
    };

    StorageDecider.saveNewTransactionHistory = function(transactionList, cbfn) {
      if (window.odse.GenericUtilities.isRunningOnServer() === true) {
        return window.odse.OdseApiCall.callSaveNewTransactionHistoryApi(transactionList, cbfn);
      }
    };

    StorageDecider.saveNewNodeIdPathList = function(nodeIdPathList, cbfn) {
      if (window.odse.GenericUtilities.isRunningOnServer() === true) {
        return window.odse.OdseApiCall.callSaveNewNodeIdPathListApi(nodeIdPathList, cbfn);
      }
    };

    StorageDecider.saveBothTransactionHistoryAndNewNodeIdPathList = function(transactionList, nodeIdPathList, blobId, cbfn) {
      nodeIdPathList = [nodeIdPathList];
      if (window.odse.GenericUtilities.isRunningOnServer() === true) {
        return window.odse.OdseApiCall.callSaveNewTransactionHistoryApi(transactionList, (function(_this) {
          return function(saveNewTransactionHistoryResponse) {
            return window.odse.OdseApiCall.callSaveNewNodeIdPathListApi(nodeIdPathList, function(saveNewNodeIdPathListResponse) {
              return cbfn(saveNewTransactionHistoryResponse, saveNewNodeIdPathListResponse, blobId);
            });
          };
        })(this));
      } else {
        return window.odse.ClientOdseStorage.callSaveNewTransactionHistoryApi(transactionList, (function(_this) {
          return function(saveNewTransactionHistoryResponse) {
            return window.odse.ClientOdseStorage.callSaveNewNodeIdPathListApi(nodeIdPathList, function(saveNewNodeIdPathListResponse) {
              return cbfn(saveNewTransactionHistoryResponse, saveNewNodeIdPathListResponse, blobId);
            });
          };
        })(this));
    ...
    StorageDecider.getNodeIdPathList = function(blobId, cbfn) {
      if (window.odse.GenericUtilities.isRunningOnServer() === true) {
        return window.odse.OdseApiCall.callGetNodeIdPathListApi(blobId, cbfn);
      } else {
        return window.odse.ClientOdseStorage.callGetNodeIdPathListApi(blobId, cbfn);
      }
    };

    StorageDecider.getTransactionHistory = function(blobId, cbfn) {
      if (window.odse.GenericUtilities.isRunningOnServer() === true) {
        return window.odse.OdseApiCall.callGetTransactionHistoryApi(blobId, cbfn);
      } else {
        return window.odse.ClientOdseStorage.callGetTransactionHistoryApi(blobId, cbfn);
      }
    };
  ...
  InitialDataDissection = (function() {
    ...
    function InitialDataDissection() {
      ...
      this.getBlobId = bind(this.getBlobId, this);
    }
    ...
    InitialDataDissection.prototype.getBlobId = function() {
      return blobId;
    };
  ...
  ConstructOdseTree = (function() {
    var _buildData, _buildTree, _getNewNode, data, nodeIdPathObj, nodeIdPropertyNameMap, transactioNodeManagerObj, transactionList, tree;
      ...
      window.odse.StorageDecider.getNodeIdPathList(blobId, (function(_this) {
        return function(blobIdParam, nodeIdPathList) {
          ...
          return window.odse.StorageDecider.getTransactionHistory(blobId, function(blobIdParam, transactionListParam) {
            ...
            return cbfn(data, tree);
          });
        };
      })(this));
    }

    _buildData = function(currentNodeObj) {
      var res;
      res = null;
      if ((currentNodeObj instanceof window.odse.ObjectNode) === true) {
        res = {};
        currentNodeObj.forEach(function(key, node) {
          return res[nodeIdPropertyNameMap[key]] = _buildData(node);
        });
      } else if ((currentNodeObj instanceof window.odse.ArrayNode) === true) {
        res = [];
        currentNodeObj.forEach(function(node, index) {
          return res.push(_buildData(node));
        });
      } else if ((currentNodeObj instanceof window.odse.PrimitiveNode) === true) {
        res = currentNodeObj.getValue();
      }
      return res;
    };

    _getNewNode = function(nodeTypeName, transactionObj) {
      var currentNodeObj;
      currentNodeObj = null;
      if (nodeTypeName === window.odse.OdseConfigs.newArrayStringConstant) {
        currentNodeObj = new window.odse.ArrayNode();
      } else if (nodeTypeName === window.odse.OdseConfigs.newObjectStringConstant) {
        currentNodeObj = new window.odse.ObjectNode();
      } else if (nodeTypeName === window.odse.OdseConfigs.newPrimitiveStringConstant) {
    ...
    _buildTree = function() {
      var cn, elementToBeAdded, item, j, k, l, len1, len2, len3, reference, referenceStack;
      ...
      for (j = 0, len1 = transactionList.length; j < len1; j++) {
        ...
        if (item.type === window.odse.OdseConfigs.newArrayStringConstant) {
          ...
          for (k = 0, len2 = referenceStack.length; k < len2; k++) {
            reference = referenceStack[k];
            if (reference.nodeId === item.nodeId) {
          ...
          elementToBeAdded = referenceStack[referenceStack.length - 1];
          nodeIdPropertyNameMap[elementToBeAdded.nodeId] = item.propertyName;
          for (l = 0, len3 = referenceStack.length; l < len3; l++) {
            reference = referenceStack[l];
            if (reference.nodeId === item.nodeId) {
  ...
  BasicTestRunner = (function() {
    function BasicTestRunner() {
      var jsonString;
      ...
      if (window.odse.GenericUtilities.isRunningOnServer() === false) {
        window.odse.OdseApiCall.clearAllOdseDataApi((function(_this) {
          return function(response1) {
            var blobId2;
            return blobId2 = window.odse.InitialDataDissectionObj.run(jsonString, 'ARSDP3vSx01QNiPGARSDP3vSx01QNiPGARSDP3vSx01QNiPGARSDP3vSx01QNiPGARSDP3vSx01QNiPGARSDP3vSx01QNiPGARSDP3vSx01QNiPGARSDP3vSx01QNiPG', function(response2, response3, blobId1) {
              var constructOdseTreeObj;
              return constructOdseTreeObj = new window.odse.ConstructOdseTree(blobId1, function(response4, response5) {
                console.log(response4, 5);
                return console.log(response5, 6);
              });
            });
          };
        })(this));
